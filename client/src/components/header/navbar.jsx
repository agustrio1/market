...
const Navbar = () => {
  ...
  return (
    <nav className="bg-blue-700 p-4 shadow-lg fixed w-full z-10">
      ...
      {/* Mobile Sidebar */}
      <div
        className={`md:hidden w-64 bg-blue-700 h-800 fixed top-0 right-0 rounded-bl transition-transform transform ${
        ...
        <div className="pb-4 px-4">
          <button onClick={toggleAccountDropdown} className="text-white py-2">
            Account
          </button>
          <div
            className={`origin-top-right absolute right-9 mt-1 w-48 rounded-md shadow-lg ${
              accountOpen ? "block" : "hidden"
            }`}>
            <div className="py-1 bg-white rounded-md">
              <Link
